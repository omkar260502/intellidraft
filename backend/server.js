...
app.post("/api/messages", async (req, res) => {
  ...
  try {
    ...
    //         {
    //           type: "text",
    //           text: `Generate a legal agreement for ${searchQuery} according to Indian Judiciary System and remove other text like the note and Here's a sample legal rent agreement for Indian people`,
    //         },
    //       ],
    //     },
    //   ],
