      ...
      messages: [
        {
          ...
          content: [
            {
              type: "text",
              text: `Generate a legal agreement for ${searchQuery} according to Indian Judiciary System and remove other text like the note and Here's a sample. and keep the input feilds bold`,
            },
          ],
        },
      ],
